...
from transformers.models.clip.modeling_clip import CLIPPreTrainedModel,CLIP_TEXT_INPUTS_DOCSTRING,_expand_mask,CLIPTextEmbeddings,CLIPAttention,CLIPMLP
