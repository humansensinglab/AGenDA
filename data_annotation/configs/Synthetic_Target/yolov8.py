...
train_batch_size_per_gpu = 1024
val_batch_size_per_gpu = 512
test_batch_size_per_gpu = 512
...
dataset_A_train = dict(
    ...
    dataset=dict(
        ...
        ann_file='annotations_coco_FakeBBoxes:42.36px_ForIoU:0.500_Pseudo-YOLOV8-SynUGRC-STACKDAAMHeatMaps-Clf-Refine.json',
...
work_dir = '../work_dirs/yolov8/LINZ2UGRC/yolov8_train_syn_ugrc_test_real_ugrc'