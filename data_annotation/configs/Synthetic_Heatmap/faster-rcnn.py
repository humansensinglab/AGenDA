...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='annotations_coco_FakeBBoxes:42.36px_ForIoU:0.500_Pseudo-FasterRCNN-SynLINZ-STACKDAAMHeatMaps-ConfThresh:0.60.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root_val + 'annotations_coco_FakeBBoxes:42.36px_ForIoU:0.500_Pseudo-FasterRCNN-SynLINZ-STACKDAAMHeatMaps-ConfThresh:0.60.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args
)
...
work_dir = '../work_dirs/faster-rcnn/LINZ2UGRC/faster-rcnn_train_syn_linz_hmap_test_syn_ugrc_hmap'
